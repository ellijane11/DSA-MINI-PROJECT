...
export default function PassengerParcelPage() {
    ...
    const [recipient, setRecipient] = useState<"driver" | "passenger" | "both">("passenger");
    ...
    const handleSendRequest = useCallback(() => {
        if (selectedOption && pickupLocation && dropoffLocation) {
            ...
            const fromName = senderName || localStorage.getItem('current_user_email') || 'Driver';
    ...
    }, [selectedOption, pickupLocation, dropoffLocation, location, recipient, date, weight, notes, senderName]);
